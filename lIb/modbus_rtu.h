...
{
	/* 03H 06H 读写保持寄存器 */
  	int16_t temperature_reg; //0x0   //第一个值是识别好  为0x1234
    int16_t humidity_reg; //0x1   //
    int16_t gassPressure_reg; //0x2   
    int16_t sunLight_reg; //0x3   
    ...
    int16_t  comm_mode_reg;//0x68
    int16_t  protocol_reg;//0x69
    int16_t  upload_time_reg;//0x6a
